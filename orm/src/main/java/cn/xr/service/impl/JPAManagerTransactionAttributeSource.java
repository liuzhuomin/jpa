...
class JPAManagerTransactionAttributeSource implements TransactionAttributeSource {

	private final TransactionAnnotationParser annotationParser = new SpringTransactionAnnotationParser();
	 ...
	 */
	public JPAManagerTransactionAttributeSource() {
	}
